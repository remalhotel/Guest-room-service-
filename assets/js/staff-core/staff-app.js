...
window.currentOffersList = currentOffersList;
...
// Exposer initStaffState
window.initStaffState = initStaffState;

console.log('✅ Staff state loaded, supabaseClient:', supabaseClient ? 'OK' : 'MISSING');
